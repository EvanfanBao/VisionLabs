...
Rect ROI;
Mat pureImg;
int countIndex = 1;///记录下标
const int ROIWIDTH = 92;
const int ROIHEIGHT = 112;
const string myFaceDir = "/Users/evan/Desktop/Junior_fall_winter/CV/att_faces/s42/";
...
//    {
//        string path = "/Users/evan/Desktop/Junior_fall_winter/CV/att_faces/s42/" + to_string(i) + ".jpg";
//        my_pic = imread(path);
//        resize(my_pic, my_pic_resized, Size(96, 128));
